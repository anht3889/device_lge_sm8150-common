...
static int shutdown() {
    LOG(ERROR) << "Lge Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char ** /* argv */) {
    ...
    LOG(INFO) << "Lge Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "Lge Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();
